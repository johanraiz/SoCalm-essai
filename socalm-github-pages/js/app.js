...
const routes = [
  ...
  { pattern: /^\/outil\/([a-z0-9-]+)\/([a-z0-9]+)$/, screen: OutilRespirationScreen, params: m => ({ slug: m[1], step: m[2] }) },
  { pattern: /^\/outil\/([a-z0-9-]+)$/, screen: OutilRespirationScreen, params: m => ({ slug: m[1] }) },
