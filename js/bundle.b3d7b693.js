...
const onboardingSteps = [
  ...
  },
  {
    ...
    disclaimer: [
      "Dernière chose, importante : SoCalm ne remplace pas une thérapie.",
...
//
// TEXTE DES PHRASES : proposition de Claude, pas un texte validé — à corriger ou réécrire par Johan
// avant toute mise en avant définitive (principe déjà posé : Claude ne décide jamais seul du texte
// final visible par l'utilisateur).
...
// cohérent avec le reste de SoCalm). Échelle en mots, jamais un chiffre — décision déjà actée avec
