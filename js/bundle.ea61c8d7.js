          ...
          <div class="entry-row-wrap">
            ...
            ${pendingReanticipationId === p.id ? `
              <div class="plan-block" data-reanticipation-block="${p.id}">
                <div class="h">Maintenant que tu viens de le faire : à quel point cette situation te semble-t-elle difficile aujourd'hui ?</div>
                <div class="usage-note">Rappelle-toi, chaque pas est important, la note n'est pas importante, c'est la progression sur le long terme qui compte. Chaque pas, même plus petit, je gagne du terrain sur mon angoisse.</div>
